...
For more information, see [license](https://github.com/seakintruth/VBA-JiggleMouse/blob/master/LICENSE.md).
...
Contributions are welcome. If you would like to contribute to the project you can do so by forking the repository and submitting your changes in a pull request. You can submit issues using [GitHub Issues](https://github.com/seakintruth/VBA-JiggleMouse/issues).
